        ...
        <div className="flex text-center justify-center items-center gap-4 flex-col">
          ...
          <div className="flex gap-2 flex-col">
            ...
            <p className="text-lg leading-relaxed tracking-tight text-muted-foreground max-w-xl text-center">
              Orchestrate all the operating systems with just one screen.
            </p>
          </div>
          <div className="grid text-left w-full grid-cols-3 lg:grid-cols-4 divide-x pt-20">
            ...
            <div className="px-3 py-1 md:px-6 md:py-4  gap-2 flex flex-col">
              ...
              <p className="text-sm text-muted-foreground">
                Our goal is to streamline developing, making it easier and faster
                than ever for everyone, everywhere.
              </p>
